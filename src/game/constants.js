  ...
  DEFEND: [
    {
      ...
      activePlayerIds:["a_cm","a_st1","h_cb1","h_cb2","h_dm"],
      supportOptionIds:["h_dm","h_cb2"], pressurePlayerIds:["h_dm"], openPlayerIds:["a_st1"],
      crowdedZone:{ x:30, y:35, w:22, h:30, label:"danger" },
      routePreview:{ from:"a_cm", to:"a_st1", kind:"danger", label:"danger ball" },
    ...
    },
    {
      ...
      ballZone:"central_defense", ballCarrierId:"a_st1", pressure:"high", openSide:"goal", insideCrowded:false,
      cues:[
      ...
      activePlayerIds:["a_st1","h_cb1","h_gk"],
      supportOptionIds:["h_gk"], pressurePlayerIds:["h_cb1"], openPlayerIds:["a_st1"],
      crowdedZone:null,
      routePreview:{ from:"a_st1", to:null, kind:"danger", label:"through ball" },
    ...
    },
    {
      ...
      activePlayerIds:["a_st1","h_gk","h_cb1","h_cb2","a_cm"],
      visiblePlayerIds:["a_st1","h_gk","h_cb1","h_cb2","a_cm"],
      supportOptionIds:["h_gk"], pressurePlayerIds:["h_gk"], openPlayerIds:["a_st1"],
      crowdedZone:null,
      routePreview:{ from:"a_st1", to:null, kind:"danger", label:"spot kick" },
      ...
      positions:{
        a_st1:{ x:33, y:50, pose:"run", runDir:-1 },
    ...
    },
    {
      ...
      activePlayerIds:["a_st1","h_cb1","h_gk","h_dm","a_cm"],
      visiblePlayerIds:["a_st1","h_cb1","h_gk","h_dm","a_cm"],
      supportOptionIds:["h_cb1","h_gk"], pressurePlayerIds:["h_cb1"], openPlayerIds:["a_st1"],
      crowdedZone:{ x:24, y:42, w:20, h:22, label:"last challenge" },
      routePreview:{ from:"a_st1", to:null, kind:"danger", label:"clear run" },
      ...
      positions:{
        a_st1:{ x:38, y:45, pose:"run", runDir:-1 },
    ...
    },
    {
      ...
      ballZone:"left_defense", ballCarrierId:"a_lm", pressure:"high", openSide:"central", insideCrowded:false,
      cues:[
      ...
      activePlayerIds:["a_lm","a_st1","h_rb","h_cb1","h_gk"],
      supportOptionIds:["h_cb1"], pressurePlayerIds:["h_rb"], openPlayerIds:["a_st1"],
      crowdedZone:{ x:16, y:50, w:18, h:28, label:"cutback zone" },
      routePreview:{ from:"a_lm", to:"a_st1", kind:"danger", label:"cutback" },
    ...
    },
    {
      ...
      activePlayerIds:["a_cm","a_st1","h_dm","h_cb1","h_cb2"],
      supportOptionIds:["h_cb1","h_cb2"], pressurePlayerIds:["h_dm"], openPlayerIds:["a_st1"],
      crowdedZone:null,
      routePreview:{ from:"a_cm", to:"a_st1", kind:"danger", label:"through run" },
    ...
    },
    {
      ...
      activePlayerIds:["a_cm","a_st1","h_cb1","h_cb2","h_dm","h_gk"],
      supportOptionIds:["h_dm","h_gk"], pressurePlayerIds:["h_cb1"], openPlayerIds:["a_st1"],
